...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "id.rockierocker.grpc.product.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<id.rockierocker.product.HelloRequest,
      id.rockierocker.product.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = id.rockierocker.product.HelloRequest.class,
      responseType = id.rockierocker.product.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<id.rockierocker.product.HelloRequest,
      id.rockierocker.product.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<id.rockierocker.product.HelloRequest, id.rockierocker.product.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<id.rockierocker.product.HelloRequest, id.rockierocker.product.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  id.rockierocker.product.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  id.rockierocker.product.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(id.rockierocker.product.HelloRequest request,
        io.grpc.stub.StreamObserver<id.rockierocker.product.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                id.rockierocker.product.HelloRequest,
                id.rockierocker.product.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public id.rockierocker.product.HelloReply sayHello(id.rockierocker.product.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<id.rockierocker.product.HelloReply> sayHello(
        id.rockierocker.product.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((id.rockierocker.product.HelloRequest) request,
              (io.grpc.stub.StreamObserver<id.rockierocker.product.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return id.rockierocker.product.ProductProto.getDescriptor();
    }
